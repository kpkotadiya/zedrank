...
function Nakamoto() {
  ...
  useEffect(() => {
    axios
      .get(
        "https://apix.zedranks.com/api/v1/listings?type=genesis&genotype=Z1&bloodline=nakamoto"
      )
      .then((response) => {
    ...
    axios
      .get(
        "https://apix.zedranks.com/api/v1/listings?type=genesis&genotype=Z2&bloodline=nakamoto"
      )
      .then((response) => {
        if (response.data !== 0) {
